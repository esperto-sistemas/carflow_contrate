...
function FailureMark() {
  return (
    <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-red-100 text-red-700" aria-hidden="true">
      <svg viewBox="0 0 24 24" className="h-12 w-12" fill="none" stroke="currentColor" strokeWidth="2.2">
  ...
  return (
    <section className="rounded-lg border border-red-200 bg-red-50">
      <div className="rounded-xl border border-red-100 bg-white p-6 text-center shadow-sm">
        <FailureMark />
        <p className="mt-4 text-sm font-semibold uppercase tracking-wide text-red-700">Pagamento não confirmado</p>
        <h2 className="mt-2 text-2xl font-bold text-gray-950">Não foi possível concluir sua assinatura</h2>
        <p className="mx-auto mt-3 max-w-xl text-sm text-gray-700">
          Houve uma falha na confirmação do pagamento. Gere uma nova cobrança na contratação ou entre em contato com o suporte para finalizar sua assinatura.
        </p>
      </div>
    </section>
  );
