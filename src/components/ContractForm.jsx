...
import ORIGEM from "../constants/origemEnum";
...
export default function ContractForm({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (origemParam === ORIGEM.EXTREME && typeof onUpdate === "function") {
        onUpdate("origem", ORIGEM.EXTREME);
      }
    } catch (e) {
      // ignore
    }
  ...
  return (
    <form
      className="rounded-lg border border-primary-100 bg-white p-5 shadow-sm md:p-7"
      onSubmit={onSubmit}
    >
      ...
      <div className="mb-7">
        ...
        <p className="mt-2 max-w-2xl text-gray-600">
          Preencha os dados da empresa e escolha a forma de pagamento para
        ...
        {isPromoPlan ? (
          <div className="rounded-lg border border-primary-600 bg-primary-50 p-4 ring-2 ring-primary-100">
            ...
            <span className="mt-1 block text-sm text-gray-600">
              Primeira parcela. Depois R$ 59,90/mês.
            </span>
          </div>
        ) : (
      ...
      <section className="mt-8 space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div
            ref={(node) => {
              fieldRefs.current.nomeResponsavel = node;
            }}
          >
            <Field label="Responsável" error={errors.nomeResponsavel}>
              <TextInput
                ...
                onChange={(event) =>
                  onUpdate("nomeResponsavel", event.target.value)
                }
              />
            </Field>
          </div>
          <div
            ref={(node) => {
              fieldRefs.current.nomeEmpresa = node;
            }}
          >
            <Field label="Empresa" error={errors.nomeEmpresa}>
              <TextInput
                ...
                onChange={(event) =>
                  onUpdate("nomeEmpresa", event.target.value)
                }
              />
            </Field>
          </div>
          <div
            ref={(node) => {
              fieldRefs.current.cpfCnpj = node;
            }}
          >
            <Field label="CPF/CNPJ" error={errors.cpfCnpj}>
              <TextInput
                ...
                onChange={(event) =>
                  onUpdate("cpfCnpj", onMask(event.target.value, "cpfCnpj"))
                }
              />
            </Field>
          </div>
          ...
          >
            <Field label="Telefone" error={errors.telefone}>
              <TextInput
                ...
                onChange={(event) =>
                  onUpdate("telefone", onMask(event.target.value, "phone"))
                }
              />
            </Field>
          </div>
      ...
      <section className="mt-8 space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-6">
            ...
            <Field label="CEP" error={errors.cep}>
              <div className="relative">
                <TextInput
                  ...
                  error={errors.cep}
                  onChange={(event) =>
                    onUpdate("cep", onMask(event.target.value, "cep"))
                  }
                />
                {cepLoading ? (
          ...
          >
            <Field label="Rua" error={errors.rua}>
              <TextInput
                ...
                value={form.rua}
                error={errors.rua}
                onChange={(event) => onUpdate("rua", event.target.value)}
              />
            </Field>
          </div>
          <div
          ...
          <div className="md:col-span-4">
            <Field label="Complemento" error={errors.complemento}>
              <TextInput
                ...
                placeholder="Sala, bloco, fundos..."
                value={form.complemento}
                onChange={(event) =>
                  onUpdate("complemento", event.target.value)
                }
              />
            </Field>
          </div>
          ...
          <div
            ...
            ref={(node) => {
              fieldRefs.current.cidadeNome = node;
            }}
          >
        ...
        {form.formaPagamento === "CREDIT_CARD" ? (
          <div className="grid gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4 md:grid-cols-6">
            <div
              className="md:col-span-3"
              ref={(node) => {
                fieldRefs.current.numeroCartao = node;
              }}
            >
              <Field label="Número do cartão" error={errors.numeroCartao}>
                <TextInput
                  ...
                  onChange={(event) =>
                    onUpdate("numeroCartao", onMask(event.target.value, "card"))
                  }
                />
              </Field>
            </div>
            <div
              className="md:col-span-3"
              ref={(node) => {
                fieldRefs.current.nomeTitular = node;
              }}
            >
              <Field label="Nome do titular" error={errors.nomeTitular}>
                <TextInput
                  ...
                  onChange={(event) =>
                    onUpdate("nomeTitular", event.target.value.toUpperCase())
                  }
                />
              </Field>
            </div>
            <div
              className="md:col-span-2"
              ref={(node) => {
                fieldRefs.current.validade = node;
              }}
            >
              <Field label="Validade" error={errors.validade}>
                <TextInput
                  ...
                  maxLength={7}
                  onChange={(event) =>
                    onUpdate("validade", onMask(event.target.value, "validade"))
                  }
                />
              </Field>
            </div>
            ...
            >
              <Field label="CVV" error={errors.cvv}>
                <TextInput
                  ...
                  maxLength={4}
                  onChange={(event) =>
                    onUpdate("cvv", onMask(event.target.value, "cvv"))
                  }
                />
              </Field>
            </div>
            <div
              className="md:col-span-2"
              ref={(node) => {
                fieldRefs.current.cpfTitular = node;
              }}
            >
              <Field label="CPF do titular" error={errors.cpfTitular}>
                <TextInput
                  ...
                  maxLength={14}
                  onChange={(event) =>
                    onUpdate("cpfTitular", onMask(event.target.value, "cpf"))
                  }
                />
              </Field>
            </div>
      ...
      <button
        className="btn btn-primary mt-8 w-full justify-center py-3 text-base"
        disabled={submitting}
        type="submit"
      >
