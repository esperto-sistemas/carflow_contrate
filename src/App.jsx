...
const FAILED_PAYMENT_STATUSES = new Set(["FAILED", "CANCELED", "OVERDUE", "REFUNDED", "CHARGEBACK", "DECLINED"]);
...
export default function App() {
  ...
  const paymentState = String(paymentStatus?.asaasStatus || payment?.status || "").toUpperCase();
    ...
    <main className="min-h-screen bg-primary-50 text-gray-900">
      ...
      <section className="mx-auto grid max-w-5xl gap-6 px-4 py-8 lg:grid-cols-[1fr_320px]">
        ...
        {!result ? (
          ...
          <PaymentPending payment={payment} copied={copied} onCopyPix={copyPix} />
        )}
